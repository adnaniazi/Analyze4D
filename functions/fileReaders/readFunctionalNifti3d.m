function [data,header] = readFunctionalNifti3d(numFilesToRead)
%% Read NIFTI 3D (functional)
filePaths = uipickfiles('Type' , {'*.nii', 'NIFTI'}, 'Prompt', 'Please select NIFTI files with .nii extension', 'NumFiles', numFilesToRead);
filePaths = filePaths';
