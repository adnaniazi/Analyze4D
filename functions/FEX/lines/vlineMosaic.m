function lineHandles = vline(x, lineType, label, textPosition, axesHandle, color, yLimsLow, yLimsHigh)
...
% Acknowledgement:  It was based on vline() written by Brandon Kuczenski.
    ...
    yLimits= [yLimsLow yLimsHigh];%get(axesHandle,'ylim');             % Row vector    
    ...
    set(lineHandles,'tag','vline','handlevisibility','off', 'Color', color)
