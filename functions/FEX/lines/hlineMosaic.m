function lineHandles = hline(y, lineType, label, textPosition, axesHandle, color, xLimsLow, xLimsHigh)
...
% Acknowledgement:  It was based on hline() written by Brandon Kuczenski.
    ...
    xLimits= [xLimsLow  xLimsHigh] ; %get(axesHandle,'xlim');             % Row vector    
    ...
    set(lineHandles,'tag','hline','handlevisibility','off', 'Color', color) 
