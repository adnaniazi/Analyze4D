...
% Last Modified by GUIDE v2.5 04-May-2012 16:19:57
...
path = path(1:end- numel('\functions\prompts\about'));
path = fullfile(path, 'assets', 'aboutScreen.png');
img = imread(path);
...
set(handles.picture,'units','pixels');
set(handles.picture,'OuterPosition',[0 0 width height]);
set(handles.picture,'position',[0 0 width height]);
imagesc(img);
axis off;
